...
consumer_secret = 'n9izWfr8ZHud9mm07zbdbzZEhq98DkfGRgorjwdMffd4iTZL9l'
...
#tweets_list = get_twits(10, 'amazon prime music')

#for t in tweets_list:
	#pprint.pprint(t)
	# print(t['twit_text'].decode('utf-8'))
	# print(t['user']['user_name'])
