...
def insert_data(file_path, dbname, table_name, sep = '\t', new_table = False):
	...
	with open(file_path, 'r') as file_object:
		columns = file_object.readline().strip().split(sep)
...
DATA_FOLDER = os.path.realpath(__file__).split('/')[:-1] + ['data']
